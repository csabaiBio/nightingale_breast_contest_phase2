...
source = '/home/ngsci/clam_level1_tiles_resnet_embeddings/'  ##### HARDCODED!
...
def build_256_1024_series_from_resnet50_features(xp, yp, non_white_features_4k_block):
    # fill zero for white img embedding 
    sequence_embs  = np.zeros( (256,1024), dtype=np.float16 )
...
def do_process_for_a_slide(filename):
    ...
    savedir = '/home/ngsci/resnet50_embeddings_4096region_256times1024_level1_holdout/'         #### HARDCODED !
        ...
        for align in range(0, offset_uqs.shape[0]):
            ...
            for g in tqdm( range( 0, len(grid_cells_all)) ): # go along all 4096x4096 patch one-by-one
                ...
                if len(intersection_filt) > 26: 
                    ...
                    preds = build_256_1024_series_from_resnet50_features( x_pos, y_pos, patches_imgs_intersection )
...
files_to_thread_folder = '/home/ngsci/resnet50_embeddings_4096region_256times1024_level1_file_splits/'              #### HARDCODED !
