...
def train_dino(args):
    ...
    utils.restart_from_checkpoint(
        os.path.join(args.output_dir, "checkpoint0020.pth"), #"ViT16-256_dino_pretraining_on_bracs_level1.pth"),
...
def train_one_epoch(student, teacher, teacher_without_ddp, dino_loss, data_loader,
    ...
    for it, images in enumerate(metric_logger.log_every(data_loader, 10, header)):
        ...
        for i, param_group in enumerate(optimizer.param_groups):
            param_group["lr"] = 3e-4 # lr_schedule[it]                 #### FIXED LEARNING RATE !
        ...
        with torch.no_grad():
            m = 0.9999 # momentum_schedule[it]  # momentum parameter                ### FIXED value !
